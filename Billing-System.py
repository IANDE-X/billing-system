...
class Bill_App:
    def __init__(self, root):
        ...
        title = Label(self.root, text="GRAND ROYALE MERCHANTS BILLING SYSTEM", bd=12, relief=RIDGE, font=("Arial Black", 20), bg="#A569BD",
                      fg="gold").pack(fill=X)
        # ===================================variables=======================================================================================
        self.nutella = IntVar()
        self.noodles = IntVar()
        ...
        bill_title = Label(billarea, text="Bill Area", font=("Arial Black", 17), bd=7, relief=GROOVE, bg="green"
                           ).pack(fill=X)

        scrol_y = Scrollbar(billarea, orient=VERTICAL)
        self.txtarea = Text(billarea, yscrollcommand=scrol_y.set,bg="grey")
        ...
        button_total = Button(button_frame, text="Total Bill", font=("Arial Black", 10), pady=10, bg="green", bd=5, relief=GROOVE,
                               command=lambda: total(self)).grid(row=0, column=0, padx=12)
        button_clear = Button(button_frame, text="Clear Field", font=("Arial Black", 10), pady=10, bg="grey", bd=5, relief=GROOVE,
                               command=lambda: clear(self)).grid(row=0, column=1, padx=10, pady=6)
        button_exit = Button(button_frame, text="Exit", font=("Arial Black", 10), pady=10, bg="red", bd=5, relief=GROOVE,
                             width=8, command=lambda: exit1(self)).grid(row=0, column=2, padx=10, pady=6)
        Developer = Label(button_frame, text="Developed & Designed by IANDE,NO:+254717426922,").grid(
            row=1, column=1, )
        intro(self)
